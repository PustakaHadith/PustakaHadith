...
| Internet | Tidak diperlukan (data hadis sudah dibundel) |
...
3. Aplikasi sedia digunakan — data hadis (62,169 hadis) sudah dimasukkan
   ke dalam aplikasi. Tiada muat turun atau tetapan API diperlukan.

> Aplikasi berfungsi sepenuhnya luar talian. Tiada internet diperlukan
> selepas pemasangan.
...
| **Sambungan gagal / tiada internet** | Tidak diperlukan — aplikasi berfungsi sepenuhnya luar talian. |
...
*Dokumen: `dokumen/manual/MANUAL_INSTALASI.md` · Folder binaan installer ·
