...
hadis". Versi dipindahkan dari halaman Tetapan ke header utama sebelah
logo "Pustaka Hadis".
...
- **Manual pengguna dipecah dua** — `MANUAL_PENGGUNA.md` diganti oleh
  `MANUAL_INSTALASI.md` (keperluan sistem, pasang, kunci API, kemas
  kini, penyelesaian masalah, nyahpasang, privasi) + `MANUAL_PENGGUNAAN.md`
...
- **Audit sunnah.com (8o)** — `python semak.py --audit-sunnah=50`
  ...
  (dirujuk dalam peta dokumen + MANUAL_INSTALASI.md §5).
...
**Senarai rasmi fail ZIP (petang 13 Ogos):** `MANUAL_INSTALASI.md`
...
| `dokumen/manual/MANUAL_PENGGUNAAN.md` | Bar teks bawah terjemahan didokumenkan (3 pautan + fungsi) |
...
1. **Katalog tuntutan** — setiap ayat fakta dalam `MULA_CEPAT.md`
   (§1–4) dan `MANUAL_PENGGUNAAN.md` (§1–3) disenaraikan: angka data,
...
2. **Audit MANUAL_INSTALASI.md + BACA_SAYA.txt vs skrip .bat sebenar**
...
- **`semak_rtl_dokumen()` (semak #14 semak.py)** — kunci audit RTL:
  frasa susun atur lama dalam TRANSFORMASI_DETAIL.md/MANUAL_PENGGUNAAN.md
...
- **`semak_rtl_dokumen()` kini tutup 4 fail**: TRANSFORMASI_DETAIL.md +
  MANUAL_PENGGUNAAN.md + **README.md** (imbas penuh — dokumen keadaan
...
reka bentuk lama (1116×788) — seksyen TEMA MANUAL_PENGGUNAAN.md kekal
...
| 19 | **Dokumentasi pengguna: MANUAL_INSTALASI.md + MANUAL_PENGGUNAAN.md** — Gate 6/INSTALLER §18 ("dokumentasi pengguna/privasi/sokongan sedia"): Manual Instalasi (3 cara: Store/MSIX ⏳ · Setup EXE ✓ per-user, naik taraf/nyahpasang tak padam data · Zip penguji; kali pertama buka + Tetapan API hadis.my; lokasi data `%LOCALAPPDATA%\PustakaHadis` — hadis.db/user_settings.json/bookmarks.json; masalah lazim; atribusi); Manual Penggunaan (9 kitab 62,169 hadis; skrin utama; carian kata kunci + makna AI; lompat terus hadis 433/bukhari 433/B433/Ctrl+G; baca hadis dua lajur Arab|Transliterasi + Melayu|Indonesia|English; darjat/huraian SemakHadis/syarah; Lapor ralat/Kongsi/Salin/WhatsApp/🔊 TTS; penanda halaman; tetapan tema/fon/bahasa/API bertopeng; mod luar talian) — manual sedia Gate 6, skrin/privasi/sokongan Store menyusul | §18 |
| 20 | **Kerja persediaan lanjutan (selepas sesi 20 Ogos):** ZIP mudah alih `installer\output\PustakaHadis-portable-1.0.0-x64.zip` (0.54 GB, 7,027 fail) ✅; `VM_MSIX_CAPTURE.md` — persediaan VM bersih, snapshot, payload, aset, wizard manual capture ✅; `MSIX_CAPTURE_PROSES.md` — checklist 6 fasa + rollback + output Gate 6 ✅; `DASAR_PRIVASI.md` (tiada data dikumpul, data tempatan, API tertutup, AI luar talian) ✅; `PAUTAN_SOKONGAN.md` (templat GitHub Issues) ✅; `TANGKAPAN_SKRIN.md` (4 wajib + 4 disyorkan, spesifikasi 1366×768/1920×1080) ✅; CHECKLIST diperluas (5C: ZIP, VM docs, proses; Dokumentasi: ☑; Uji Win10: ⏳); PLAN 4C/4D dikemas kini; semak.py 388 LULUS | — |
...
PublisherDisplayName`); MANUAL_INSTALASI.md + MANUAL_PENGGUNAAN.md
